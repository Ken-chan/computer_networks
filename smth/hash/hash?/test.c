...
/*
    for (size_t i = 0; i < set->nitems; ++i) {
        printf("%s | ", hashset_iterator_value(iter));
...
int main()
{
    ...
    test_exceptions();
    printf("test_exceptions - OK\n");
    test_rehashing_items_placed_beyond_nitems();
    printf("test_rehashing_items_placed_beyond_nitems - OK\n");
    test_iterating();
    printf("test_iterating - OK\n");
    test_fill_with_deleted_items();
    printf("test_fill_with_deleted_items - OK\n");
